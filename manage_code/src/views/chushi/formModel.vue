		...
		<el-dialog modal-class="edit_form_modal" class="edit_form" v-model="formVisible" :title="formTitle" width="80%" destroy-on-close :fullscreen='false'>
			<el-form class="formModel_form" ref="formRef" :model="form" :rules="rules">
				<el-row >
					<el-col :span="12">
						<el-form-item label="工号" prop="gonghao">
							<el-input class="list_inp" v-model="form.gonghao" placeholder="工号"
								type="text" :readonly="!isAdd||disabledForm.gonghao?true:false" />
						</el-form-item>
					</el-col>
					<el-col :span="12">
					...
					<el-col :span="12">
						<el-form-item label="厨师姓名" prop="chushixingming">
							<el-input class="list_inp" v-model="form.chushixingming" placeholder="厨师姓名"
                                type="text"
								:readonly="!isAdd||disabledForm.chushixingming?true:false" />
						</el-form-item>
					</el-col>
	...
	const init=(formId=null,formType='add',formNames='',row=null,table=null,statusColumnName=null,tips=null,statusColumnValue=null)=>{
		...
		if(formType == 'add'){
			...
			for(let x in row){
				...
				if(x=='chushixingming'){
					form.value.chushixingming = row[x];
					disabledForm.value.chushixingming = true;
					continue;
				}
				if(x=='xingbie'){
