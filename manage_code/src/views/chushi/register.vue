	...
	<div>
		<div class="register_view">
			<el-form :model="registerForm" class="register_form">
				...
				<div class="list_item">
					<div class="list_label">工号：</div>
					<el-input class="list_inp"
						 v-model="registerForm.gonghao" 
						 placeholder="请输入工号"
						 type="text"
						/>
				</div>
				...
				<div class="list_item">
					<div class="list_label">厨师姓名：</div>
					<el-input class="list_inp"
						 v-model="registerForm.chushixingming" 
						 placeholder="请输入厨师姓名"
						 type="text"
						/>
				</div>
				<div class="list_item">
					...
					<el-select 
						...
						placeholder="请选择性别"
						>
						<el-option v-for="item in chushixingbieLists" :label="item" :value="item"></el-option>
					</el-select>
				</div>
...
<script setup>
	...
	const chushixingbieLists = ref([])
	const init=()=>{
		chushixingbieLists.value = "男,女".split(',')
	}
	...
	const handleRegister = () => {
		...
		if((!registerForm.value.gonghao)){
			context?.$toolUtil.message(`工号不能为空`,'error')
			return false
		}
		...
		if((!registerForm.value.chushixingming)){
			context?.$toolUtil.message(`厨师姓名不能为空`,'error')
			return false
		}
...
<style lang="scss" scoped>
	...
	.register_view {
        background-image: url("http://clfile.zggen.cn/20241022/7703c914d6fb429097fef7f9242e37c1.jpg")!important;
		// 表单盒子
		.register_form {
		}
		// 标题样式
