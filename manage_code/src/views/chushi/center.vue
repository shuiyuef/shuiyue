				...
				<el-row>
					<el-col :span="12">
						<el-form-item label="工号" prop="gonghao">
							<el-input class="list_inp" v-model="user.gonghao" readonly placeholder="工号" clearable />
						</el-form-item>
					</el-col>
					<el-col :span="12">
						<el-form-item label="厨师姓名" prop="chushixingming">
							<el-input class="list_inp" v-model="user.chushixingming"  placeholder="厨师姓名" clearable />
						</el-form-item>
					</el-col>
					<el-col :span="12">
					...
					<el-col :span="12">
						<el-form-item label="头像" prop="touxiang">
							<uploads
								...
								@change="chushitouxiangUploadSuccess">
							</uploads>
						</el-form-item>
					</el-col>
					<el-col :span="12">
...
<script setup>
	...
	const chushitouxiangUploadSuccess=(fileUrls)=> {
	    user.value.touxiang = fileUrls;
	}
	const onSubmit = () => {
		if((!user.value.gonghao)){
