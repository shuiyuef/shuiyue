		...
		<div class="login_view">
			<el-form :model="loginForm" class="login_form">
				...
				<div class="btn_view">
					...
					<el-button class="register" type="primary" @click="handleRegister('chushi')">注册厨师</el-button>
				</div>
			</el-form>
		</div>
	</div>
...
/* 按钮 */
.login_form .btn_view{  width: 100%;  display: flex; flex-wrap:wrap; justify-content:center; order:11;   margin:10px 0 0;  }
