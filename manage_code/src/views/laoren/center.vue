				...
				<el-row>
					...
					<el-col :span="12">
						<el-form-item label="饮食禁忌" prop="yinshijinji">
							<el-input class="list_inp" v-model="user.yinshijinji"  placeholder="饮食禁忌" clearable />
						</el-form-item>
					</el-col>
					<el-col :span="12">
						<el-form-item label="偏好口味" prop="pianhaokouwei">
							<el-input class="list_inp" v-model="user.pianhaokouwei"  placeholder="偏好口味" clearable />
						</el-form-item>
					</el-col>
