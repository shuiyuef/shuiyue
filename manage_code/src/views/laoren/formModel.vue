		...
		<el-dialog modal-class="edit_form_modal" class="edit_form" v-model="formVisible" :title="formTitle" width="80%" destroy-on-close :fullscreen='false'>
			<el-form class="formModel_form" ref="formRef" :model="form" :rules="rules">
				<el-row >
					...
					<el-col :span="12">
						<el-form-item label="饮食禁忌" prop="yinshijinji">
							<el-input class="list_inp" v-model="form.yinshijinji" placeholder="饮食禁忌"
                                type="text"
								:readonly="!isAdd||disabledForm.yinshijinji?true:false" />
						</el-form-item>
					</el-col>

					<el-col :span="12">
						<el-form-item label="偏好口味" prop="pianhaokouwei">
							<el-input class="list_inp" v-model="form.pianhaokouwei" placeholder="偏好口味"
                                type="text"
								:readonly="!isAdd||disabledForm.pianhaokouwei?true:false" />
						</el-form-item>
					</el-col>
	...
	const init=(formId=null,formType='add',formNames='',row=null,table=null,statusColumnName=null,tips=null,statusColumnValue=null)=>{
		...
		if(formType == 'add'){
			...
			for(let x in row){
				...
				if(x=='yinshijinji'){
					form.value.yinshijinji = row[x];
					disabledForm.value.yinshijinji = true;
					continue;
				}
				if(x=='pianhaokouwei'){
					form.value.pianhaokouwei = row[x];
					disabledForm.value.pianhaokouwei = true;
					continue;
				}
				if(x=='money'){
