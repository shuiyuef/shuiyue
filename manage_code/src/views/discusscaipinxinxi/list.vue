	...
	<div>
		<div class="center_view">
			...
			<div class="list_search_view">
				...
				<div class="btn_view">
					<el-button class="add_btn" type="success" @click="addClick" v-if="btnAuth('discusscaipinxinxi','新增')">
			...
			<el-table
                ...
                <el-table-column v-if="btnAuth('discusscaipinxinxi','修改')" label="禁用账号" :resizable='true' :sortable='false' align="left" header-align="left">
                    <template #default="scope">
				...
				<el-table-column label="操作" width="300" :resizable='true' :sortable='true' align="left" header-align="left">
					<template #default="scope">
						<el-button class="edit_btn" type="primary" @click="editClick(scope.row.id)" v-if=" btnAuth('discusscaipinxinxi','修改')">
						...
						<el-button class="del_btn" type="danger" @click="delClick(scope.row.id)" >
							...
							删除						</el-button>
						<el-button class="operate_btn" v-if="btnAuth('discusscaipinxinxi','查看评论')" type="warning" @click="commentClick(scope.row.id)">
