...
public class CaipinxinxiController {
    ...
    public R page(@RequestParam Map<String, Object> params,CaipinxinxiEntity caipinxinxi,
                    ...
                    String tableName = request.getSession().getAttribute("tableName").toString();
                                                                                                                                                                                                                                                                                                                                                                                            if(tableName.equals("chushi")) {
                    caipinxinxi.setGonghao((String)request.getSession().getAttribute("username"));
                                    }
                                                                QueryWrapper<CaipinxinxiEntity> ew = new QueryWrapper<CaipinxinxiEntity>();
    ...
    public R info(@PathVariable("id") Long id){
        CaipinxinxiEntity caipinxinxi = caipinxinxiService.getById(id);
		caipinxinxi = caipinxinxiService.selectView(new QueryWrapper<CaipinxinxiEntity>().eq("id", id));
    ...
    public R save(@RequestBody CaipinxinxiEntity caipinxinxi, HttpServletRequest request){
        ...
        caipinxinxiService.save(caipinxinxi);
    ...
    public R delete(@RequestBody Long[] ids){
        caipinxinxiService.removeBatchByIds(Arrays.asList(ids));
        return R.ok();
    }
    ...
    QueryWrapper<CaipinxinxiEntity> wrapper = new QueryWrapper<CaipinxinxiEntity>();
		if(map.get("remindstart")!=null) {
    ...
    long count = caipinxinxiService.count(wrapper);
    ...
    public R autoSort2(@RequestParam Map<String, Object> params,CaipinxinxiEntity caipinxinxi, HttpServletRequest request){
        ...
        if(pageList.size()<limit) {
            ...
            ew = new QueryWrapper<CaipinxinxiEntity>();
            if(recommendations.size()>0){
                ew.notIn("id", recommendations);
            }
            ew.orderByDesc("id");
            ew.last("limit "+toAddNum);
            pageList.addAll(caipinxinxiService.list(ew));
    ...
    public R count(@RequestParam Map<String, Object> params,CaipinxinxiEntity caipinxinxi, HttpServletRequest request){
        ...
        QueryWrapper<CaipinxinxiEntity> ew = new QueryWrapper<CaipinxinxiEntity>();
    long count = caipinxinxiService.count(MPUtil.sort(MPUtil.between(MPUtil.likeOrEq(ew, caipinxinxi), params), params));
