		...
		<div class="usersView">
			...
			<div class="usersBox updateInfo" v-if="tabIndex=='center'">
				<el-form class="usersForm" ref="userFormRef" :model="userForm" label-width="120px" :rules="rules">
					<el-row>
						<el-col :span="12">
							<el-form-item prop="gonghao" label="工号">
								<el-input class="list_inp" v-model="userForm.gonghao" placeholder="工号" readonly></el-input>
							</el-form-item>
						</el-col>
						<el-col :span="12">
							<el-form-item prop="chushixingming" label="厨师姓名">
								<el-input class="list_inp" v-model="userForm.chushixingming" placeholder="厨师姓名" ></el-input>
							</el-form-item>
						</el-col>
						<el-col :span="12">
...
<script setup>
	...
	const getSession = () =>{
		context?.$http({
			...
			context?.$toolUtil.storageSet("frontName", res.data.data.gonghao)
