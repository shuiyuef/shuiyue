...
<script setup>
	...
	const getInfo = ()=>{
		context?.$http({
			...
			res.data.data.caipinxiangqing = res.data.data.caipinxiangqing.replace(reg,'../../../cl941024116/file');
	...
	const init = (formId=null,formType='add',formNames='',row=null,table=null,statusColumnName=null,tips=null,statusColumnValue=null) => {
		...
		context?.$http({
			...
			if(json.hasOwnProperty('gonghao') && context?.$toolUtil.storageGet("frontRole")!="管理员"){
